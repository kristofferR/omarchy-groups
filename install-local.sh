...
for file in BarWidget.qml BarCompatibility.js LayoutModel.js GroupIcons.js LucideIcons.js LucideKeywords.js Settings.qml assets/icon.svg assets/LICENSE-lucide.txt preview.png manifest.json LICENSE; do
